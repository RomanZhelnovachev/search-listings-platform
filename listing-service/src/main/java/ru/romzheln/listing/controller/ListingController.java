...
public interface ListingController {
  ...
  @PutMapping("/{id}")
  ListingResponse update(@PathVariable Long id, @RequestBody UpdateListingRequest request);

  @PatchMapping("/{id}/price")
  ListingResponse changePrice(
  ...
  void addPromotion(
      @PathVariable Long id, @Valid @RequestBody ChangeListingPromotionRequest request);

  @DeleteMapping("/{id}/promotion")
  void disablePromotion(@PathVariable Long id);

  @PatchMapping("/{id}/mortgage")
  void addMortgagePrograms(
      @PathVariable Long id, @RequestBody ChangeListingMortgageProgramsRequest request);

  @PatchMapping("/{id}/mortgage/remove")
  void removeMortgagePrograms(
      @PathVariable Long id, @RequestBody ChangeListingMortgageProgramsRequest request);
