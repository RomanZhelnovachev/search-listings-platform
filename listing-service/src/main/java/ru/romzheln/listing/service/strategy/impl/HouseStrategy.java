...
public class HouseStrategy extends AbstractPropertyStrategy {
  ...
  public Property create(CreatePropertyRequest request) {
    ...
    CommonPhysicalDetails commonPhysicalDetails =
        mapper.buildCommonPhysicalDetails(houseRequest.getCommonPhysicalDetailsDto());
    LandUse landUse = resolver.getLandUse(houseRequest.getCommonLandDetailsDto().landUse());
    CommonLandDetails commonLandDetails =
        mapper.buildCommonLandDetails(houseRequest.getCommonLandDetailsDto(), landUse);
    House house =
        House.builder()
            .property(property)
            .commonPhysicalDetails(commonPhysicalDetails)
            ...
            .additionalBuildings(
                resolver.getAllAdditionalBuildingsById(houseRequest.getAdditionalBuildings()))
  ...
  public Property update(Long id, UpdatePropertyRequest request) {
    ...
    if (houseRequest.getCommonPhysicalDetailsDto() != null) {
      mapper.updateCommonPhysicalDetails(
          house.getCommonPhysicalDetails(), houseRequest.getCommonPhysicalDetailsDto());
    }
    if (houseRequest.getCommonLandDetailsDto() != null) {
      ...
      mapper.updateCommonLandDetails(
          house.getCommonLandDetails(), houseRequest.getCommonLandDetailsDto(), landUse);
    }
