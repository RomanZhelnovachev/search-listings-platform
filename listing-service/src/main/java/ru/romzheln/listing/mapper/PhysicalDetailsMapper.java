...
public class PhysicalDetailsMapper {
  ...
  public ApartmentPhysicalDetails buildApartmentPhysicalDetails(
      ApartmentPhysicalDetailsDto request) {
  ...
  public CommercialPhysicalDetails buildCommercialPhysicalDetails(
      CommercialPhysicalDetailsDto request) {
  ...
  public void updateCommonPhysicalDetails(
      CommonPhysicalDetails details, CommonPhysicalDetailsDto request) {
  ...
  public void updateApartmentPhysicalDetails(
      ApartmentPhysicalDetails details, ApartmentPhysicalDetailsDto request) {
  ...
  public void updateCommercialPhysicalDetails(
      CommercialPhysicalDetails details, CommercialPhysicalDetailsDto request) {
    UpdateUtil.setIfNotNull(request.floor(), details::setFloor);
  ...
  public void updateCommonLandDetails(
      CommonLandDetails details, CommonLandDetailsDto request, LandUse landUse) {
